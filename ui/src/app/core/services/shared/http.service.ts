...
export class HttpService {
    ...
    public post(url: string, body: any, headers?: any): Promise<ResponseData> {
        return this.asPromise(this._http.post(url, body, this.requestOptions(headers)));
    }
    ...
    private requestOptions(headers?: any) {
